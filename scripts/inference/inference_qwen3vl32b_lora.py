...
def load_model(model_path: str = "models/qwen3-vl-32b-sft"):
    """
    표준 PEFT 방식으로 LoRA 어댑터가 적용된 모델과 프로세서를 로드합니다.
    학습 시 AutoModelForVision2Seq + peft.get_peft_model()로 학습한 모델을 로드합니다.
    """
    base_model_id = "unsloth/Qwen3-VL-32B-Instruct-unsloth-bnb-4bit"
    ...
    print(f"🔗 LoRA 어댑터 로드 중: {model_path}")
...
def main():
    ...
    parser.add_argument("--model-path", type=str, default="models/qwen3-vl-32b-sft", help="학습된 모델 경로")
